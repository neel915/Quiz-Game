"use strict"; // Activation du mode strict pour une meilleure gestion des erreurs
// Importation des questions depuis le fichier `questions.js`
// Avant : Aucune question n’était importée dynamiquement, ce qui limitait le contenu des questions.
import { cultureGeneral } from "./questions.js";
// === Sélection des éléments HTML ===
// Avant : Les éléments HTML étaient sélectionnés dans différents endroits, ce qui créait de la redondance.
// Après : Les éléments sont centralisés au début pour une meilleure organisation et facilité d'utilisation.
...
// Avant : La fonction `loadQuestion` initiale ne nettoyait pas les options précédentes et ne gérait pas correctement l'affichage dynamique des questions.
// Après : `loadQuestion` est structurée pour charger chaque question avec ses propres options et vérifier les réponses.
...
next.addEventListener("click", () => {
  ...
  if (currentQuestionIndex < cultureGeneral.questions.length) {
    ...
    text.innerText = "Fin du Quiz"; // Indique la fin du quiz
